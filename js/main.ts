...
var allProducts: Products[]=[article1,article2,article3,article4,article5,article6,article7,article8,article9,article10,article11,article12,article13,article14,article15,article16,article17,article18,article19,article20];
var cart: Products[] = [];
...
function calculateSumCart(cart: Products[]) {
    var sum = 0;
...
function renderProducts(x: Products[]): void {
    var i: number = 0;
    while (i < x.length) {
        writeHtml(x[i]);
...
function writeHtml(pro: Products) {
